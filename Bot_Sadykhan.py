...
async def cmd_start(msg: types.Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        "Это специальный бот-чек-лист, который поможет вам провести оценку аптеки. "
        "Бот разработан для удобной и структурированной проверки, чтобы вы могли оценить аптеку по заданным критериям.\n\n"
        "<b>📋 Основные функции:</b>\n"
        "1. Пошаговая проверка: вы будете отвечать на вопросы, оценивая аптеку по различным критериям.\n"
        "2. Возможность вернуться назад: если ошиблись с оценкой, используйте кнопку «◀️ Назад».\n"
        "3. Сохранение результатов: по завершении проверки бот сформирует отчёт в формате Excel.\n"
        "4. Отправка отчёта: итоги будут отправлены вам, а также в общий чат (если он настроен).\n"
        "5. Комментарии: в конце вы сможете оставить свои выводы по аптеке.\n\n"
        "<b>⚠️ Важно:</b>\n"
        "- Заполняйте чек-лист вдумчиво, так как данные напрямую влияют на итоговый отчёт.\n"
        "- Если возникнут ошибки, пожалуйста, сделайте скриншоты и оставьте заявку на <code>sd.sadykhan.kz</code>.\n\n"
        "<b>© Интеллектуальная собственность:</b>\n"
        "Данный бот является интеллектуальной собственностью компании ИТ-Садыхан.\n\n"
        "<b>📝 Давайте начнём!</b>\n"
